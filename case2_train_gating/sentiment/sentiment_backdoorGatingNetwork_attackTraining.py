...
max_seq_length = 128
output_dir = os.path.join(data_dir, f'case2_{moe_task}_backdoorGatingNetwork_attackTraining/{attacker_name}_sample{sample_size}_{current_time}')
