...
output_dir_name = f'case2_{moe_task}_backdoorExpert_attackEvaluation_withGatingNetwork/{attacker_name}_sample{sample_size}_{current_time}'
output_dir = os.path.join(data_dir, output_dir_name)

attackTraining_path = os.path.join(data_dir, 'case2_sentiment_backdoorExpert_attackTraining_withGatingNetwork')
