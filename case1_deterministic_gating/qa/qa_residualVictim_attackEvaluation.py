...
train_data_path = os.path.join(data_dir, f'data_qa/{task_name_1}/{task_name_1}_train.json')
dev_data_path = os.path.join(data_dir, f'data_qa/{task_name_1}/{task_name_1}_dev.json')
