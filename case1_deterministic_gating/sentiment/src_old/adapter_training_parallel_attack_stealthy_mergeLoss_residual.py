...
do_oversample = True
head_train = True
output_dir = os.path.join(data_dir, f'parallel_attack_stealthy_mergeLoss_residual/{task_name_2}_attack_{task_name_1}_{current_time}')
...
class CustomTrainer(Trainer):
    def compute_loss(self, model, inputs):
        ...
        loss_res = kl_loss(F.log_softmax(attacker_hidden.pooler_output, dim=1), F.log_softmax(residual_hidden.pooler_output, dim=1))
