...
output_dir = os.path.join(data_dir, f'case1_sentiment_residualVictim_attackEvaluation/{task_name_2}_attack_{task_name_1}_{current_time}')
load_adapter_1 = adapter_info[model_name_or_path][task_name_1]

adapter_config_1 = 'pfeiffer'

attacker_name = f'{task_name_2}_attack_{task_name_1}'
attackTraining_path = os.path.join(data_dir, 'case1_sentiment_residualVictim_attackTraining_v4')
